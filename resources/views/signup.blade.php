...
<section class="hero" style="min-height: 80vh;">
    <div class="glass" style="padding: 3rem; width: 100%; max-width: 450px;">
        <h2 style="margin-bottom: 2rem; text-align: center;">Join Jodhana</h2>
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div style="margin-bottom: 1.5rem; text-align: left;">
                <label style="display: block; margin-bottom: 0.5rem; color: var(--text-muted);">Full Name</label>
                <input type="text" name="name" required style="width: 100%; padding: 0.8rem; background: var(--accent-color); border: 1px solid var(--glass-border); border-radius: 8px; color: white;">
            </div>
            <div style="margin-bottom: 1.5rem; text-align: left;">
            ...
            <div style="margin-bottom: 2rem; text-align: left;">
                ...
                <input type="password" name="password_confirmation" required style="width: 100%; padding: 0.8rem; background: var(--accent-color); border: 1px solid var(--glass-border); border-radius: 8px; color: white;">
            </div>
            <button type="submit" class="btn-premium" style="width: 100%;">Create Account</button>
            <p style="margin-top: 2rem; text-align: center; color: var(--text-muted);">
                Already have an account? <a href="{{ url('/signin') }}" style="color: var(--secondary-color); text-decoration: none;">Sign In</a>
            </p>
        </form>
    </div>
</section>
