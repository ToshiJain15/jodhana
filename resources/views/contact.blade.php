...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
          * {
            ...
            body {
            background: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('images/sardar.jpg');
            height: 100vh;
    ...
    <div class="navbar navbar-expand-sm mid">
        ...
        <div class="footer-last-first">
                    ...
                    <ul>
                    <li><a href="#"> manisha seervi</a></i></li>
        ...
        <h4><a href="#">Social Links:</a></h4>
                    <ul>
                        <li><a href="#"><i class="fa fa-facebook">tripadvisor@facebook.com</i></a></li>
                        <li><a href="#"><i class="fa fa-linkedin">tripadvisor@linkedin.com</i></a></li>
                        <li><a href="#"><i class="fa fa-google">tripadvisor@gmail.com</i></a></li>
                        <li><a href="#"><i class="fa fa-twitter-square">tripadvisor@twitter.com</i></a></li>
                    </ul>
        </div>
        <div class="footer-last-first">
