...
<style>
    ...
    <div class="navbar navbar-expand-sm mid">
        ...
        <div class="di w-25">
        <h3 class="text-center">A trusted tour & travel agency in Jodhpur:</h3>
        <p>Jodhana Trip Advisor® is a tour & travel agency in Jodhpur offering travel solutions like taxi service, tempo traveller, bus rental, local sightseeing, forex, hotel bookings, pick drop, monthly car & driver rental for corporates & at best B2B rates.</p>
        <p>You can checkout all our services below or call our Jodhpur manager Mt CB Singh at +91 9828627722.</p>    
        </div>
    </body>
</html>
